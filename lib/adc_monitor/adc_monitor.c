...
//         { .atten = ADC_ATTEN_CURRENT, .channel = ADC_CURR_A, .unit = ADC_UNIT_2, .bit_width = ADC_BITWIDTH_12 },
//         { .atten = ADC_ATTEN_CURRENT, .channel = ADC_CURR_B, .unit = ADC_UNIT_2, .bit_width = ADC_BITWIDTH_12 },
//         { .atten = ADC_ATTEN_CURRENT, .channel = ADC_CURR_A, .unit = ADC_UNIT_2, .bit_width = ADC_BITWIDTH_12 },
//         { .atten = ADC_ATTEN_CURRENT, .channel = ADC_CURR_B, .unit = ADC_UNIT_2, .bit_width = ADC_BITWIDTH_12 },
//         { .atten = ADC_ATTEN_VOL, .channel = ADC_VOL_A,  .unit = ADC_UNIT_2, .bit_width = ADC_BITWIDTH_12 },
//         { .atten = ADC_ATTEN_VOL, .channel = ADC_VOL_B,  .unit = ADC_UNIT_2, .bit_width = ADC_BITWIDTH_12 },
//         { .atten = ADC_ATTEN_VOL, .channel = ADC_BAT,    .unit = ADC_UNIT_2, .bit_width = ADC_BITWIDTH_12 }
//     };
